...
const PRIMARY_ROUTES=["/","/cohorts","/affiliates","/automation","/smartlinks"];
...
export default function AdminSidebar(props:Props){
 ...
 const items:PrimaryItem[]=[
  ...
  {href:"/affiliates",label:"Affiliate Optimizer",icon:"users",show:props.mayPartners},
  {href:"/automation",label:"Auto-Rotation",icon:"rotation",show:props.mayAutomation},
  {href:"/smartlinks",label:"Smartlink Intelligence",icon:"spark",show:props.maySmartlinks},
 ];
 const secondary=[
