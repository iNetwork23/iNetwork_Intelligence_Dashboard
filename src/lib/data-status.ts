...
const SYNC_KEYS={history:'everflow_history',ltv:'ltv_cohorts_materialized',fraud:'fraud_conversion_backfill_berlin_v4'} as const;
...
const cachedSyncStates=unstable_cache(loadSyncStates,['data-status-v1-berlin-v5'],{revalidate:60,tags:['data-status']});
