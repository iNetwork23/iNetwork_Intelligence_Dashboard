...
describe('source value copy controls',()=>{
 ...
 it('renders one accessible icon button for a concrete value',()=>{const html=renderToStaticMarkup(<CopyValue label="ADV2" value="P-3591625022"/>);expect(html).toContain('ADV2 P-3591625022 kopieren');expect(html).toContain('copyValueButton');expect(html).toContain('aria-live="polite"')});
