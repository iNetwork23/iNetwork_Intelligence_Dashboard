...
declare
  ...
  v_command text;
begin
  -- cron.job allows SELECT but not UPDATE/FOR UPDATE for its regular owner.
  -- Serialize this repair and its rollback; mutate through pg_cron's owner-checked API.
