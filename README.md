...
- Nachfolgende authentifizierte Prüfung: [Kohorten-Navigation, Fraud-Timeout, Geldbeträge und Hydrierung von Startseite/Zeitraum/Seitenleiste](docs/WLX-BROWSER-ACCEPTANCE-2026-09-07.md). Das Folgepaket besteht 196 Testdateien / 1599 Tests; vollständige Projektabnahme bleibt offen.
