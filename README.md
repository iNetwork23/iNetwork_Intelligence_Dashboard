...
- Nachfolgende authentifizierte Prüfung: [Kohorten-Navigation, Fraud-Timeout, Geldbeträge und Zeitraum-Hydrierung](docs/WLX-BROWSER-ACCEPTANCE-2026-09-07.md). Das Folgepaket besteht 194 Testdateien / 1597 Tests; vollständige Projektabnahme bleibt offen.
