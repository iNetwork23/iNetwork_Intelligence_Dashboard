...
- Nachfolgende authentifizierte Prüfung: [Kohorten-Navigation, Fraud-Timeout, Geldbeträge und Hydrierung von Zeitraum/Seitenleiste](docs/WLX-BROWSER-ACCEPTANCE-2026-09-07.md). Das Folgepaket besteht 195 Testdateien / 1598 Tests; vollständige Projektabnahme bleibt offen.
